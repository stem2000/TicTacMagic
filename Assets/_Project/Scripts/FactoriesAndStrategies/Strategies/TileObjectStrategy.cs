...
namespace TicTacMagic
{
    public class TileObjectStrategy : EffectStrategy<TOSFrame>, ITargetStrategy
    {
        ...
        private IEnumerator<float> _Spawn(Tile tile)
        {
            ...
            Timing.RunCoroutine(_SpawnTileObject(tile));
